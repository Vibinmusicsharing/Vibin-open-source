...
public class MenuListAdapter extends ArrayAdapter<MenuActionItem> {
    ...
    public View getView (int position, View convertView, ViewGroup parent) {
        ...
        if(rowView == null) {
            ...
            viewHolder.menuItemSwitch = (SwitchCompat) rowView.findViewById(R.id.switch_notifications);
        ...
        if(position == MenuActionItem.ITEM1.ordinal()) {
            ...
            holder.menuItemSwitch.setVisibility(View.VISIBLE);
        }
    ...
    private static class MenuItemViewHolder {
        ...
        public SwitchCompat menuItemSwitch;
    }
