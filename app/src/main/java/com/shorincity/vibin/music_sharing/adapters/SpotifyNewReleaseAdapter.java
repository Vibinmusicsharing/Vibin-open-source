...
public class SpotifyNewReleaseAdapter extends RecyclerView.Adapter<SpotifyNewReleaseAdapter.ExampleViewHolder> {

    private Context mContext;
    private ArrayList<SpotifyNewReleaseModel.Item> list;

    public SpotifyNewReleaseAdapter(Context context, ArrayList<SpotifyNewReleaseModel.Item> exampleList){
        mContext = context;
        list = exampleList;
    }
    ...
    public ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.adapter_new_release,parent,false);
    ...
    public void onBindViewHolder(@NonNull ExampleViewHolder holder, int position) {
        SpotifyNewReleaseModel.Item currentItem = list.get(position);
