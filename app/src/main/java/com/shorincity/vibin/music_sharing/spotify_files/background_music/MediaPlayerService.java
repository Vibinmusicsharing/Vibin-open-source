package com.shorincity.vibin.music_sharing.spotify_files.background_music;
...
import com.shorincity.vibin.music_sharing.UI.MainActivity;
...
public class MediaPlayerService extends MediaBrowserServiceCompat implements MediaPlayer.OnCompletionListener, AudioManager.OnAudioFocusChangeListener {
    ...
    private MediaSessionCompat.Callback mMediaSessionCallback = new MediaSessionCompat.Callback() {
        ...
        public boolean onMediaButtonEvent(Intent mediaButtonEvent) {
            Log.e("TEST","onMediaButtonEvent intent():"+mediaButtonEvent);
        ...
        public void onPrepareFromSearch(String query, Bundle extras) {
            ...
            Log.e("TEST","onPrepareFromSearch: "+query);
        ...
        public void onPlayFromSearch(String query, Bundle extras) {
            ...
            Log.e("TEST","onPlayFromSearch: "+query);
            try {
                ...
                e.printStackTrace();
                Log.e("TEST","onPlayFromSearch.error : "+e.toString());
            }
        }
