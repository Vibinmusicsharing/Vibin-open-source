...
public class Logging {
	 ...
	 *            The message you would like logged.
	 * @param args
	 *            Arguments for msg's String formatting. Last object may be a
	 *            throwable.
	 */
	public static int v(final String tag, final String msg,
                        final Object... args) {
	...
	public static void dLong(String message) {
		int maxLogSize = 2000;
	 ...
	 *            The message you would like logged.
	 * @param args
	 *            Arguments for msg's String formatting.
	 * @param tr
	 *            A Throwable for printing stack traces.
	 */
	private static int log(final int level, final String tag, final String msg,
