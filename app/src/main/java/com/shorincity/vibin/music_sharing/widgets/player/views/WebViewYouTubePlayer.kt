package com.shorincity.vibin.music_sharing.widgets.player.views
...
import com.shorincity.vibin.music_sharing.widgets.player.*
import com.shorincity.vibin.music_sharing.widgets.player.listeners.YouTubePlayerListener
import com.shorincity.vibin.music_sharing.widgets.player.options.IFramePlayerOptions
import com.shorincity.vibin.music_sharing.widgets.player.utils.Utils
import java.util.*
...
internal class WebViewYouTubePlayer constructor(
    ...
    override fun setQuality(videoQuality: PlayerConstants.PlaybackQuality) {
        mainThreadHandler.post { loadUrl("javascript:onQualityChange(${videoQuality.getValue()})") }
    }
    ...
    private fun initWebView(playerOptions: IFramePlayerOptions) {
        ...
        val htmlPage = Utils
            .readHTMLFromUTF8File(resources.openRawResource(R.raw.youtube_player))
