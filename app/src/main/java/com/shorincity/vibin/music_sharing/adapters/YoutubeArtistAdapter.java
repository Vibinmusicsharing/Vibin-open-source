...
public class YoutubeArtistAdapter extends RecyclerView.Adapter<YoutubeArtistAdapter.ExampleViewHolder> {

    private Context mContext;
    private ArrayList<HomeYoutubeModel.YoutubeCustomModel> list;

    public YoutubeArtistAdapter(Context context, ArrayList<HomeYoutubeModel.YoutubeCustomModel> exampleList){
        mContext = context;
        list = exampleList;
    }
