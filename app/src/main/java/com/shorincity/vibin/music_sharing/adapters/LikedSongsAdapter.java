...
public class LikedSongsAdapter extends RecyclerView.Adapter<LikedSongsAdapter.ExampleViewHolder> {

    private Context mContext;
    private ArrayList<RecentSongModel> list;

    public LikedSongsAdapter(Context context, ArrayList<RecentSongModel> exampleList) {
        mContext = context;
        list = exampleList;
    }
    ...
    public ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.adapter_liked_song, parent, false);
