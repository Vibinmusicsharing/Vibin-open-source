...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageBody) {
        ...
        int unreadCount = SharedPrefManager.getInstance(this).getSharedPrefInt(AppConstants.INTENT_NOTIFICATION_UNREAD_COUNT) + 1;

        SharedPrefManager.getInstance(this).setSharedPrefInt(AppConstants.INTENT_NOTIFICATION_UNREAD_COUNT, unreadCount);
