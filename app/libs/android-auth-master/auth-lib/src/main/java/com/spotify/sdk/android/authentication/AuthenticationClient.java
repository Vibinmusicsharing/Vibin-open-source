 ...
 * After authorization flow is completed, result is returned to the activity_youtube_2
 ...
 * in the {@code onActivityResult} method of the activity_youtube_2 that initiated it.</p>
 *
 * <p>
 ...
 *
 * <pre>{@code
 * // Code called from an activity_youtube_2
 ...
 * }</pre>
 * <p>
 * To process the result activity_youtube_2 needs to override {@code onActivityResult} callback
 *
 * <pre>{@code
 ...
 *
 * <pre>{@code
 * // The activity_youtube_2 that should process the response from auth flow
 * <activity_youtube_2
 *     android:name=".MainActivity"
 *     android:label="@string/app_name"
 *     android:launchMode="singleInstance" >
 *     <intent-filter>
 *         // Any other intent filters that this activity_youtube_2 requires
 *     </intent-filter>
 *
 ...
 * }</pre>
 * <p>
 * To process the result the receiving activity_youtube_2 ({@code MainActivity} in this example) needs to override one of its
...
public class AuthenticationClient {
    ...
    /**
     * The activity_youtube_2 that receives and processes the result of authentication flow
     * and returns it to the context activity_youtube_2 that invoked the flow.
     ...
     * This activity_youtube_2 will receive the result through the
     ...
     *
     * @param contextActivity The activity_youtube_2 that should start the intent to open a browser.
     ...
     * This method can be used to open this activity_youtube_2 from components different than
     ...
     * }</pre>
     *
     * @param contextActivity A context activity_youtube_2 for the LoginActivity.
     * @param request         Authentication request
     ...
     *
     * @param contextActivity The activity_youtube_2 that was used to launch LoginActivity
     ...
     *
     * @param resultCode Result code returned with the activity_youtube_2 result.
     * @param intent     Intent received with activity_youtube_2 result. Should contain a Uri with result data.
     ...
     *
     * @param contextActivity The activity_youtube_2 that should start the intent to open the download page.
     */
